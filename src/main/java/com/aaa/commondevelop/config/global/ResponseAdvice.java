...
public class ResponseAdvice implements ResponseBodyAdvice<Object> {
    ...
    public static final String HTTP_RESULT = "com.aaa.commondevelop.config.httpResult.HttpResult";
    ...
    public Object beforeBodyWrite(Object body, MethodParameter returnType,
         ...
         * 防止重复包裹的问题出现
         * 这里的 Response 指的是 com.aaa.commondevelop.config.configRespone.Response
         * 是我们手动设置的返回值。
         */
