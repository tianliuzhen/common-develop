package com.aaa.commondevelop.codeGenerator;
...
//        pc.setModuleName(scanner("模块名"));
        pc.setParent("com.aaa.commondevelop");
      ...
      /*  cfg.setFileCreate(new IFileCreate() {
        ...
        //设置生成的实体类继承的父类
        strategy.setSuperEntityClass("com.aaa.commondevelop.common.BaseEntity");
        strategy.setEntityLombokModel(true);
        strategy.setRestControllerStyle(true);
        // 公共父类
        strategy.setSuperControllerClass("com.aaa.commondevelop.common.BaseController");
        // 写于父类中的公共字段
