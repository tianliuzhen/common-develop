...
public class SysLogAspect {
     ...
     * execution(...)
     */
    @Pointcut("@within(com.aaa.commondevelop.annotation.SysLog) || @annotation(com.aaa.commondevelop.annotation.SysLog)")
     ...
     */
    @Around("@within(com.aaa.commondevelop.annotation.SysLog) || @annotation(com.aaa.commondevelop.annotation.SysLog)")
