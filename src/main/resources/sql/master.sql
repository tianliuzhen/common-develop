...
-- ----------------------------
-- Table structure for a_copy1
-- ----------------------------
DROP TABLE IF EXISTS `a_copy1`;
CREATE TABLE `a_copy1`  (
  `a` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL
) ENGINE = InnoDB CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for a_copy1_copy1
-- ----------------------------
DROP TABLE IF EXISTS `a_copy1_copy1`;
CREATE TABLE `a_copy1_copy1`  (
  `a` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL
) ENGINE = InnoDB CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Compact;
